...
namespace Bukimedia.PrestaSharp.Factories
{
    public class ProductFeatureValueFactory : RestSharpFactory
    {
        ...
        public Task<Entities.product_feature_value> Get(long ProductFeatureValueId)
        {
        ...
        public async Task<Entities.product_feature_value> Add(Entities.product_feature_value ProductFeatureValue)
        {
            ...
            Entities.product_feature_value aux = await this.Execute<Entities.product_feature_value>(request);
            ProductFeatureValue.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.product_feature_value ProductFeatureValue)
        {
            RestRequest request = this.RequestForUpdate("product_feature_values", ProductFeatureValue.id, ProductFeatureValue);
            return this.Execute<Entities.product_feature_value>(request);
        }

        public Task Delete(long ProductFeatureValueId)
        {
            RestRequest request = this.RequestForDelete("product_feature_values", ProductFeatureValueId);
            return this.Execute<Entities.product_feature_value>(request);
        }

        public Task Delete(Entities.product_feature_value ProductFeature)
        {
            return this.Delete((long)ProductFeature.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.product_feature_value>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.product_feature_value> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.product_feature_value>>(request);
        ...
        public Task<List<Entities.product_feature_value>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.product_feature_value>> AddList(List<Entities.product_feature_value> ProductFeatureValues)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
