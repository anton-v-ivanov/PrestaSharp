...
namespace Bukimedia.PrestaSharp.Factories
{
    public class OrderCartRuleFactory : RestSharpFactory
    {
        ...
        public Task<Entities.order_cart_rule> Get(long OrderCartRuleId)
        {
        ...
        public async Task<Entities.order_cart_rule> Add(Entities.order_cart_rule OrderCartRule)
        {
            ...
            Entities.order_cart_rule aux = await this.Execute<Entities.order_cart_rule>(request);
            OrderCartRule.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.order_cart_rule OrderCartRule)
        {
            RestRequest request = this.RequestForUpdate("order_discounts", OrderCartRule.id, OrderCartRule);
            return this.Execute<Entities.order_cart_rule>(request);
        }

        public Task Delete(long OrderCartRuleId)
        {
            RestRequest request = this.RequestForDelete("order_discounts", OrderCartRuleId);
            return this.Execute<Entities.order_cart_rule>(request);
        }

        public Task Delete(Entities.order_cart_rule OrderCartRule)
        {
            return this.Delete((long)OrderCartRule.id);
        }
        ...
        /// <returns></returns> 
        public Task<List<Entities.order_cart_rule>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.order_cart_rule> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.order_cart_rule>>(request);
        ...
        public Task<List<Entities.order_cart_rule>> GetAll()
        {
        ...
        /// <returns></returns> 
        public Task<List<Entities.order_cart_rule>> AddList(List<Entities.order_cart_rule> OrderCartRules)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
            ...
            return this.Execute<List<Entities.order_cart_rule>>(request);
        }
    }
}