...
namespace Bukimedia.PrestaSharp.Factories
{
    public class ProductSupplierFactory : RestSharpFactory
    {
        ...
        public Task<Entities.product_supplier> Get(long ProductSupplierId)
        {
        ...
        public async Task<Entities.product_supplier> Add(Entities.product_supplier ProductSupplier)
        {
            ...
            Entities.product_supplier aux = await this.Execute<Entities.product_supplier>(request);
            ProductSupplier.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.product_supplier ProductSupplier)
        {
            RestRequest request = this.RequestForUpdate("product_suppliers", ProductSupplier.id, ProductSupplier);
            return this.Execute<Entities.product_supplier>(request);
        }

        public Task Delete(long ProductSupplierId)
        {
            RestRequest request = this.RequestForDelete("product_suppliers", ProductSupplierId);
            return this.Execute<Entities.product_supplier>(request);
        }

        public Task Delete(Entities.product_supplier ProductSupplier)
        {
            return this.Delete((long)ProductSupplier.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.product_supplier>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.product_supplier> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.product_supplier>>(request);
        ...
        public Task<List<Entities.product_supplier>> GetAll()
        {
            return this.GetByFilter(null, null, null);
        }

        public Task<List<Entities.product_supplier>> AddList(List<Entities.product_supplier> ProductSuppliers)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
