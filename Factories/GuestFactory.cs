...
namespace Bukimedia.PrestaSharp.Factories
{
    public class GuestFactory : RestSharpFactory
    {
        ...
        public async Task<Entities.guest> Add(Entities.guest Guest)
        {
            ...
            Entities.guest aux = await this.Execute<Entities.guest>(request);
            Guest.id = idAux;
        ...
        public Task Delete(long GuestId)
        {
            RestRequest request = this.RequestForDelete("guests", GuestId);
            return this.Execute<Entities.guest>(request);
        }

        public Task Delete(Entities.guest Guest)
        {
            return this.Delete((long)Guest.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.guest>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.guest> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.guest>>(request);
        ...
        public Task<List<Entities.guest>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.guest>> AddList(List<Entities.guest> Guests)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
