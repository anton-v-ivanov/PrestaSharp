...
namespace Bukimedia.PrestaSharp.Factories
{
    public class OrderHistoryFactory : RestSharpFactory
    {
        ...
        public Task<Entities.order_history> Get(long OrderHistoryId)
        {
        ...
        public async Task<Entities.order_history> Add(Entities.order_history OrderHistory)
        {
            ...
            Entities.order_history aux = await this.Execute<Entities.order_history>(request);
            OrderHistory.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.order_history OrderHistory)
        {
            RestRequest request = this.RequestForUpdate("order_histories", OrderHistory.id, OrderHistory);
            return this.Execute<Entities.order_history>(request);
        }

        public Task Delete(long OrderHistoryId)
        {
            RestRequest request = this.RequestForDelete("order_histories", OrderHistoryId);
            return this.Execute<Entities.order_history>(request);
        }

        public Task Delete(Entities.order_history OrderHistory)
        {
            return this.Delete((long)OrderHistory.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.order_history>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.order_history> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.order_history>>(request);
        ...
        public Task<List<Entities.order_history>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.order_history>> AddList(List<Entities.order_history> OrderHistories)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
