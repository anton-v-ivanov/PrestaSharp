...
namespace Bukimedia.PrestaSharp.Factories
{
    public class OrderStateFactory : RestSharpFactory
    {
        ...
        public Task<Entities.order_state> Get(long OrderStateId)
        {
        ...
        public async Task<Entities.order_state> Add(Entities.order_state OrderState)
        {
            ...
            Entities.order_state aux = await this.Execute<Entities.order_state>(request);
            OrderState.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.order_state OrderState)
        {
            RestRequest request = this.RequestForUpdate("order_states", OrderState.id, OrderState);
            return this.Execute<Entities.order_state>(request);
        }

        public Task Delete(long OrderStateId)
        {
            RestRequest request = this.RequestForDelete("order_states", OrderStateId);
            return this.Execute<Entities.order_state>(request);
        }

        public Task Delete(Entities.order_state OrderState)
        {
            return this.Delete((long)OrderState.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.order_state>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.order_state> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.order_state>>(request);
        ...
        public Task<List<Entities.order_state>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.order_state>> AddList(List<Entities.order_state> OrderStates)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
