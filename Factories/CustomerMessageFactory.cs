...
namespace Bukimedia.PrestaSharp.Factories
{
    public class CustomerMessageFactory : RestSharpFactory
    {
        ...
        public Task<Entities.customer_message> Get(long CustomerMessageId)
        {
        ...
        public async Task<Entities.customer_message> Add(Entities.customer_message CustomerMessage)
        {
            ...
            Entities.customer_message aux = await this.Execute<Entities.customer_message>(request);
            CustomerMessage.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.customer_message CustomerMessage)
        {
            RestRequest request = this.RequestForUpdate("customer_messages", CustomerMessage.id, CustomerMessage);
            return this.Execute<Entities.customer_message>(request);
        }

        public Task Delete(long CustomerMessageId)
        {
            RestRequest request = this.RequestForDelete("customer_messages", CustomerMessageId);
            return this.Execute<Entities.customer_message>(request);
        }

        public Task Delete(Entities.customer_message CustomerMessage)
        {
            return this.Delete((long)CustomerMessage.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.customer_message>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.customer_message> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.customer_message>>(request);
        ...
        public Task<List<Entities.customer_message>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.customer_message>> AddList(List<Entities.customer_message> CustomerMessages)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
