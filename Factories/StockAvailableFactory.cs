...
namespace Bukimedia.PrestaSharp.Factories
{
    public class StockAvailableFactory : RestSharpFactory
    {
        ...
        public Task<Entities.stock_available> Get(long StockAvailableId)
        {
        ...
        public Task Update(Entities.stock_available StockAvailable)
        {
            RestRequest request = this.RequestForUpdate("stock_availables", StockAvailable.id, StockAvailable);
            return this.Execute<Entities.stock_available>(request);
        }

        public Task Delete(long StockAvailableId)
        {
            RestRequest request = this.RequestForDelete("stock_availables", StockAvailableId);
            return this.Execute<Entities.stock_available>(request);
        }

        public Task Delete(Entities.stock_available StockAvailable)
        {
            return this.Delete((long)StockAvailable.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.stock_available>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.stock_available> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.stock_available>>(request);
        ...
        public Task<List<Entities.stock_available>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.stock_available>> AddList(List<Entities.stock_available> StockAvailables)
        {
