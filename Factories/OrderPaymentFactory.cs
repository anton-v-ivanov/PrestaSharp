...
namespace Bukimedia.PrestaSharp.Factories
{
    public class OrderPaymentFactory : RestSharpFactory
    {
        ...
        public Task<Entities.order_payment> Get(long OrderPaymentId)
        {
        ...
        public async Task<Entities.order_payment> Add(Entities.order_payment OrderPayment)
        {
            ...
            Entities.order_payment aux = await this.Execute<Entities.order_payment>(request);
            OrderPayment.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.order_payment OrderPayment)
        {
            RestRequest request = this.RequestForUpdate("order_payments", OrderPayment.id, OrderPayment);
            return this.Execute<Entities.order_payment>(request);
        }

        public Task Delete(long OrderPaymentId)
        {
            RestRequest request = this.RequestForDelete("order_payments", OrderPaymentId);
            return this.Execute<Entities.order_payment>(request);
        }

        public Task Delete(Entities.order_payment OrderPayment)
        {
            return this.Delete((long)OrderPayment.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.order_payment>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.order_payment> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.order_payment>>(request);
        ...
        public Task<List<Entities.order_payment>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.order_payment>> AddList(List<Entities.order_payment> OrderPayments)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
