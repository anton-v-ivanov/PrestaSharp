...
namespace Bukimedia.PrestaSharp.Factories
{
    public class CustomerThreadFactory : RestSharpFactory
    {
        ...
        public Task<Entities.customer_thread> Get(long CustomerThreadId)
        {
        ...
        public async Task<Entities.customer_thread> Add(Entities.customer_thread CustomerThread)
        {
            ...
            Entities.customer_thread aux = await this.Execute<Entities.customer_thread>(request);
            CustomerThread.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.customer_thread CustomerThread)
        {
            RestRequest request = this.RequestForUpdate("customer_threads", CustomerThread.id, CustomerThread);
            return this.Execute<Entities.customer_thread>(request);
        }

        public Task Delete(long CustomerThreadId)
        {
            RestRequest request = this.RequestForDelete("customer_threads", CustomerThreadId);
            return this.Execute<Entities.customer_thread>(request);
        }

        public Task Delete(Entities.customer_thread CustomerThread)
        {
            return this.Delete((long)CustomerThread.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.customer_thread>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.customer_thread> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.customer_thread>>(request);
        ...
        public Task<List<Entities.customer_thread>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.customer_thread>> AddList(List<Entities.customer_thread> CustomerThreads)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
