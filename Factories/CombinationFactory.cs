...
namespace Bukimedia.PrestaSharp.Factories
{
    public class CombinationFactory : RestSharpFactory
    {
        ...
        public Task<Entities.combination> Get(long CombinationId)
        {
        ...
        public async Task<Entities.combination> Add(Entities.combination Combination)
        {
            ...
            Entities.combination aux = await this.Execute<Entities.combination>(request);
            Combination.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.combination Combination)
        {
            RestRequest request = this.RequestForUpdate("combinations", Combination.id, Combination);
            return this.Execute<Entities.combination>(request);
        }

        public Task Delete(long CombinationId)
        {
            RestRequest request = this.RequestForDelete("combinations", CombinationId);
            return this.Execute<Entities.combination>(request);
        }

        public Task Delete(Entities.combination Combination)
        {
            return this.Delete((long)Combination.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.combination>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.combination> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.combination>>(request);
        ...
        public Task<List<Entities.combination>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.combination>> AddList(List<Entities.combination> Combinations)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
