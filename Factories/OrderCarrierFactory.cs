...
namespace Bukimedia.PrestaSharp.Factories
{
    public class OrderCarrierFactory : RestSharpFactory
    {
        ...
        public Task<Entities.order_carrier> Get(long OrderCarrierId)
        {
        ...
        public async Task<Entities.order_carrier> Add(Entities.order_carrier OrderCarrier)
        {
            ...
            Entities.order_carrier aux = await this.Execute<Entities.order_carrier>(request);
            OrderCarrier.id = idAux;
            return await this.Get((long)aux.id);
        }

        public Task Update(Entities.order_carrier OrderCarrier)
        {
            RestRequest request = this.RequestForUpdate("order_carriers", OrderCarrier.id, OrderCarrier);
            return this.Execute<Entities.order_carrier>(request);
        }

        public Task Delete(long OrderCarrierId)
        {
            RestRequest request = this.RequestForDelete("order_carriers", OrderCarrierId);
            return this.Execute<Entities.order_carrier>(request);
        }

        public Task Delete(Entities.order_carrier OrderCarrier)
        {
            return this.Delete((long)OrderCarrier.id);
        }
        ...
        /// <returns></returns>
        public Task<List<Entities.order_carrier>> GetByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
        ...
        public async Task<List<long>> GetIdsByFilter(Dictionary<string, string> Filter, string Sort, string Limit)
        {
            ...
            List<PrestaSharp.Entities.FilterEntities.order_carrier> aux = await this.Execute<List<PrestaSharp.Entities.FilterEntities.order_carrier>>(request);
        ...
        public Task<List<Entities.order_carrier>> GetAll()
        {
        ...
        /// <returns></returns>
        public Task<List<Entities.order_carrier>> AddList(List<Entities.order_carrier> OrderCarriers)
        {
            List<PrestaSharp.Entities.PrestaShopEntity> Entities = new List<PrestaSharp.Entities.PrestaShopEntity>();
